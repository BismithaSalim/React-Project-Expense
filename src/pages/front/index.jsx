...
//       route: role === "executive" ? "/cost-calculation" : "/cost-calculation",
...
const FrontPage = () => {
  const navigate = useNavigate();
  const role = getRole(); // get logged-in role
          ...
          return (
            <Grid item xs={12} sm={6} md={4} key={card.title}>
              ...
              >
                ...
                <CardActions sx={{ justifyContent: "center" }}>
                  <Tooltip title={isDisabled ? "Access restricted" : ""}>
                    <span>
                      <Button
                        variant="contained"
                        color="primary"
